...
class IssueCommentRevision(models.Model):
    ...
    comment = models.ForeignKey(IssueComment, related_name='revisions', on_delete=models.PROTECT)
...
class IssueAttachment(UIDMixin):
    issue = models.ForeignKey(Issue, related_name="attachments", on_delete=models.PROTECT)
    agenda_item = models.ForeignKey('meetings.AgendaItem', null=True,
                                    blank=True, related_name="attachments", on_delete=models.PROTECT)
...
class ProposalVoteBoard(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_("User"),
                             related_name="board_votes", on_delete=models.PROTECT)
...
class ProposalVote(models.Model):
    proposal = models.ForeignKey(Proposal, related_name='votes', on_delete=models.PROTECT)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_("User"),
...
class ProposalVoteArgument(models.Model):
    proposal_vote = models.ForeignKey(ProposalVote, related_name='arguments', on_delete=models.PROTECT)
...
class ProposalVoteArgumentRanking(models.Model):
    argument = models.ForeignKey(ProposalVoteArgument, on_delete=models.PROTECT)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_("User"),
                             on_delete=models.PROTECT,
...
class VoteResult(models.Model):
    ...
    proposal = models.ForeignKey(Proposal, related_name="results", on_delete=models.PROTECT)
    meeting = models.ForeignKey('meetings.Meeting', on_delete=models.PROTECT)
...
class IssueRankingVote(models.Model):
    voted_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT)
    issue = models.ForeignKey(Issue, related_name='ranking_votes', on_delete=models.PROTECT)
