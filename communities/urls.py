...
urlpatterns = [
    ...
    path('upcoming/publish/', views.PublishUpcomingView.as_view(),
         name="upcoming_publish"),
    path('upcoming/start/', views.StartMeetingView.as_view(),
         name="upcoming_start"),
    path('upcoming/end/', views.EndMeetingView.as_view(),
         name="upcoming_end"),
    path('edit-summary/', views.EditUpcomingSummaryView.as_view(),
         name="upcoming_edit_summary"),
    path('upcoming/publish/preview/',
         views.PublishUpcomingMeetingPreviewView.as_view(),
         name='preview_upcoming_meeting'),
    path('upcoming/edit/', views.EditUpcomingMeetingView.as_view(),
         name="upcoming_edit"),
    path('upcoming/participants/',
