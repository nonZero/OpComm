...
class AgendaItem(ConfidentialByRelationMixin):
    ...
    meeting = models.ForeignKey('Meeting', verbose_name=_("Meeting"), on_delete=models.PROTECT,
                                related_name="agenda")
    issue = models.ForeignKey(Issue, verbose_name=_("Issue"),
                              related_name="agenda_items", on_delete=models.PROTECT)
...
class MeetingParticipant(models.Model):
    meeting = models.ForeignKey(Meeting, verbose_name=_("Meeting"),
                                related_name="participations", on_delete=models.PROTECT)
