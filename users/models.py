...
class Membership(models.Model):
    community = models.ForeignKey('communities.Community', verbose_name=_("Community"),
                                  related_name='memberships', on_delete=models.PROTECT)
    ...
    invited_by = models.ForeignKey(settings.AUTH_USER_MODEL,
                                   ...
                                   blank=True)
    in_position_since = models.DateField(default=timezone.now,
...
class Invitation(models.Model):
    ...
    user = models.ForeignKey(OCUser, verbose_name=_("User"), on_delete=models.PROTECT,
                             related_name='invitations', null=True, blank=True)

    default_group_name = models.CharField(_('Group'), max_length=50,
                                          choices=DefaultGroups.CHOICES)

    status = models.PositiveIntegerField(_("Status"), choices=EmailStatus.choices, default=EmailStatus.PENDING)
